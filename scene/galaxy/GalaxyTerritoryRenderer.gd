...
const OWNERSHIP_BORDER_OUTER_FACTOR := 0.035
const OWNERSHIP_BORDER_OUTER_MIN := 2.0
const OWNERSHIP_BORDER_INNER_FACTOR := 0.10
const OWNERSHIP_BORDER_INNER_MIN := 4.0
