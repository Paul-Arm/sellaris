...
const GAME_SCENE_RUNTIME_SYSTEM_SCRIPT: Script = preload("res://scene/game/systems/GameSceneRuntimeSystem.gd")
const GAME_SCENE_VIEW_SYSTEM_SCRIPT: Script = preload("res://scene/game/systems/GameSceneViewSystem.gd")
const GAME_SCENE_SIMULATION_SYSTEM_SCRIPT: Script = preload("res://scene/game/systems/GameSceneSimulationSystem.gd")
...
var _runtime_system = GAME_SCENE_RUNTIME_SYSTEM_SCRIPT.new()
var _view_system = GAME_SCENE_VIEW_SYSTEM_SCRIPT.new()
var _simulation_system = GAME_SCENE_SIMULATION_SYSTEM_SCRIPT.new()
...
func build_bottom_drawer_runtime_entries(inspected_system_id: String = "") -> Dictionary:
	return _runtime_system.build_bottom_drawer_runtime_entries(inspected_system_id)
...
func _render_runtime_placeholders() -> void:
	_runtime_system.render_runtime_placeholders()


func _render_hyperlanes() -> void:
	_runtime_system.render_hyperlanes()
